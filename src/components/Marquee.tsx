        ...
        <div className="flex gap-0 mb-4 overflow-hidden">
          ...
          >
            {[...images, ...images].map((src, i) => (
              <div
                key={`row1-${i}`}
                className="relative w-48 h-32 shrink-0 overflow-hidden group"
              >
                <img
                  src={src}
                  alt=""
                ...
                />
                <div className="absolute inset-0 bg-void/40 group-hover:bg-transparent transition-colors duration-500" />
              </div>
            ))}
          </motion.div>
        </div>
